# Ashwini Poultry Farm - Deployment Guide
...
```env
MONGODB_URI=mongodb+srv://username:password@cluster.mongodb.net/ashwini-poultry
...
npm run seed
```
This creates: `admin@ashwini.com` / `Admin@123`
