...
async function seed() {
  ...
  // ── Users with loginId ──
  const users = [
    { loginId: 'ADM001', name: 'Admin',          email: 'admin@ashwini.com',    password: 'Admin@123',    role: 'admin'       as const },
    { loginId: 'SLS001', name: 'Ravi Sales',     email: 'sales@ashwini.com',    password: 'Sales@123',    role: 'salesperson' as const },
    { loginId: 'ACC001', name: 'Priya Accounts', email: 'accounts@ashwini.com', password: 'Accounts@123', role: 'accountant'  as const },
  ];
