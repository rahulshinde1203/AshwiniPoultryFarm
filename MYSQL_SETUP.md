# MySQL Terminal Setup — Ashwini Poultry Farm
...
```bash
mysql -u root -p -e "CREATE DATABASE ashwini_poultry CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"
```
...
```
DATABASE_URL="mysql://root:YourPassword@localhost:3306/ashwini_poultry"
...
| Role | Email | Password |
|---|---|---|
| Admin | admin@ashwini.com | Admin@123 |
| Salesperson | sales@ashwini.com | Sales@123 |
| Accountant | accounts@ashwini.com | Accounts@123 |
...
**`Unknown database 'ashwini_poultry'`**
```bash
mysql -u root -p -e "CREATE DATABASE ashwini_poultry CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"
```
...
```
DATABASE_URL="mysql://root:p%40ss%231@localhost:3306/ashwini_poultry"
```
...
| Scenario | Example |
|---|---|
| Local, no password | `mysql://root:@localhost:3306/ashwini_poultry` |
| Local with password | `mysql://root:secret@localhost:3306/ashwini_poultry` |
| Remote server | `mysql://admin:pass@db.myserver.com:3306/ashwini_poultry` |
| AWS RDS | `mysql://admin:pass@xx.rds.amazonaws.com:3306/ashwini_poultry` |
